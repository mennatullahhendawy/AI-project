...
var ASM_CONSTS = {
  4808544: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4808599: function($0) {performance.now = function() { return $0; };},  
 4808647: function($0) {performance.now = function() { return $0; };},  
 4808695: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4808750: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4808811: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4808875: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _PostJSONnum(path, value, objectName, callback, fallback) {
          var parsedPath = UTF8ToString(path);
          var parsedValue = UTF8ToString(value);
          var parsedObjectName = UTF8ToString(objectName);
          var parsedCallback = UTF8ToString(callback);
